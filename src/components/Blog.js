  ...
  return (
    <div>
      <div className="container-flex">
        <div
          className="container card card-blog-one"
        ...
        <div
          className="container card card-blog-two"
        ...
        >
          <div className="overlay">
            ...
            <div className="items descr">
              <p>
                Second attempt to deliver to the reader an unusual perspective
                of a young man, constantly dreaming about reaching the stars and
